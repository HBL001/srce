 ...
 */
 ...
 public:
     ...
     int write(uint32_t address, const uint8_t* data, size_t length); //!< Write arbitrary block of data to FT800 memory
 ...
 private:
     Spi_interface spi_interface; //!< Low-level SPI interface instance
